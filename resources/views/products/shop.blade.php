                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                <a
                                                    href="{{ route('single.product', $vegetable->id) }}">{{ $vegetable->name }}</a>
                                            </h4>
                                            <div class="card-price">
                                                {{-- <span class="discount">Rp. 300.000</span> --}}
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                <a
                                                    href="{{ route('single.product', $fish->id) }}">{{ $fish->name }}</a>
                                            </h4>
                                            <div class="card-price">
                                                {{-- <span class="discount">Rp. 300.000</span> --}}
                                                <span class="reguler">USD. {{ $fish->price }}</span>
                                            </div>
                                            <a href="{{ route('single.product', $fish->id) }}"
                                                class="btn btn-block btn-primary">
                                                display details
                                            </a>
                                        </div>
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                <a
                                                    href="{{ route('single.product', $fruit->id) }}">{{ $fruit->name }}</a>
                                            </h4>
                                            <div class="card-price">
                                                {{-- <span class="discount">Rp. 300.000</span> --}}
